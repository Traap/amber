...
LaTeX macros [autodoc](https://github.com/Traap/autodoc) uses to assemble output
from amber into a report.

Refer [autodoc](https://github.com/Traap/autodoc) to learn how an external
program amber run **must** create output factor files to have them automatically
consumed.
...
[environment.rb](https://github.com/Traap/amber/blob/master/lib/amber/environment.rb)
